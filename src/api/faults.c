...
void copyMRsFaultReply(tcb_t *sender, tcb_t *receiver, MessageID_t id, word_t length);
...
// word_t process3(tcb_t *sender, tcb_t *receiver, word_t *receiveIPCBuffer);
...
//     case seL4_Fault_UnknownSyscall:
//     {
//         // return process3(sender,receiver,receiveIPCBuffer);
