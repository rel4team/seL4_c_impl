...
//     ret.cap = lu_ret.slot->cap;
//     // printf("%llx\n",(unsigned long long)lu_ret.slot);
//     // printf("%llx %llx \n",(unsigned long long)ret.cap.words[0],(unsigned long long)ret.cap.words[1]);
...
//     // printf("%llx %llx %llx\n", (unsigned long long)TCB_PTR_CTE_PTR(thread, tcbCTable), (unsigned long long)thread, (unsigned long long)capptr);
...
{
    // printf("%llx %llx %llx %llx\n",(unsigned long long)nodeCap.words[0],(unsigned long long)nodeCap.words[1],(unsigned long long)capptr,(unsigned long long)n_bits);
