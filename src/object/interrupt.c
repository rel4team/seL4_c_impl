...
//     cap_t cap1 = cap_irq_handler_cap_new(IRQT_TO_IDX(irq));
//     cteInsert((cap_t*)&cap1, controlSlot, handlerSlot);
...
//         setThreadState(NODE_STATE(ksCurThread), ThreadState_Restart);
//         invokeIRQHandler_SetIRQHandler(irq, (cap_t*)& ntfnCap, slot);
//         return EXCEPTION_NONE;
//     }
...
//     cteInsert((cap_t*)&cap, slot, irqSlot);
// }
